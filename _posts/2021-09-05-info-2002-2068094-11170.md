...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=이태원동 이태원(이테크빌)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구이태원동이태원(이테크빌)");
  xhr.send();
