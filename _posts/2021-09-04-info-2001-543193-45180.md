...
<a href="/apt/전라북도정읍시태인면태창리">[전라북도정읍시 태인면태창리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=태인면태창리 샘들내">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도정읍시태인면태창리샘들내");
  xhr.send();
