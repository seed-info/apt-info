...
title: 대성2차
categories: [아파트정보]
permalink: /apt/서울특별시용산구용문동대성2차
---

<a style="color: blue;" href="/apt/서울특별시용산구용문동">< 서울특별시용산구 용문동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=용문동 대성2차">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구용문동대성2차");
  xhr.send();
