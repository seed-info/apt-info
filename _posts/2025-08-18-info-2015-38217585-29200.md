...
<a style="color: green;" href="https://search.naver.com/search.naver?query=우산동 우산동중흥s-클래스리버티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시광산구우산동우산동중흥s-클래스리버티");
  xhr.send();
