...
<a href="/apt/대구광역시북구태전동">[대구광역시북구 태전동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=태전동 대원">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시북구태전동대원");
  xhr.send();
