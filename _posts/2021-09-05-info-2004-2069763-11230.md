...
<a style="color: blue;" href="/apt/서울특별시동대문구이문동">[서울특별시동대문구 이문동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=이문동 삼보스위트홈">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구이문동삼보스위트홈");
  xhr.send();
