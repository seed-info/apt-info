...
<a style="color: blue;" href="/apt/서울특별시서대문구영천동">< 서울특별시서대문구 영천동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=영천동 독립문삼호">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구영천동독립문삼호");
  xhr.send();
