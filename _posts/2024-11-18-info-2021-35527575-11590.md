...
<a style="color: green;" href="https://search.naver.com/search.naver?query=사당동 이수푸르지오더프레티움">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구사당동이수푸르지오더프레티움");
  xhr.send();
