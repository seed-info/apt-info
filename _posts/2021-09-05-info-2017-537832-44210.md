...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=성연면왕정리 힐스테이트서산아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도서산시성연면왕정리힐스테이트서산아파트");
  xhr.send();
