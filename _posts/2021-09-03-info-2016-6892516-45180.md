...
<a href="/apt/전라북도정읍시수성동">[전라북도정읍시 수성동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=수성동 뉴캐슬">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도정읍시수성동뉴캐슬");
  xhr.send();
