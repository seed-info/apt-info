...
<a href="/apt/경기도의왕시오전동">[경기도의왕시 오전동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=오전동 진달래(LG)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도의왕시오전동진달래(LG)");
  xhr.send();
