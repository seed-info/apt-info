...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서둔동 수원역한양아이클래스퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도수원시권선구서둔동수원역한양아이클래스퍼스트");
  xhr.send();
