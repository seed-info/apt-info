...
<a style="color: green;" href="https://search.naver.com/search.naver?query=평리동 서대구역서한이다음더퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시서구평리동서대구역서한이다음더퍼스트");
  xhr.send();
