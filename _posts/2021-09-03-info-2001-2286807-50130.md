...
<a href="/apt/제주특별자치도서귀포시표선면표선리">[제주특별자치도서귀포시 표선면표선리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=표선면표선리 표선2차반석타운">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시표선면표선리표선2차반석타운");
  xhr.send();
