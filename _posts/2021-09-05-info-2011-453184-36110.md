...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=한솔동 첫마을1단지(퍼스트프라임)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시한솔동첫마을1단지(퍼스트프라임)");
  xhr.send();
