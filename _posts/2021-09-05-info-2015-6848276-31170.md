...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=화정동 힐스테이트이스턴베이">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시동구화정동힐스테이트이스턴베이");
  xhr.send();
