...
<a href="/apt/울산광역시북구산하동">[울산광역시북구 산하동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=산하동 힐스테이트강동">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구산하동힐스테이트강동");
  xhr.send();
