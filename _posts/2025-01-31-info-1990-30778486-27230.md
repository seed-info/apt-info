...
title: 서변
categories: [아파트정보]
permalink: /apt/대구광역시북구서변동서변
---

<a style="color: blue;" href="/apt/대구광역시북구서변동">< 대구광역시북구 서변동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서변동 서변">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시북구서변동서변");
  xhr.send();
