...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=금호동4가 힐스테이트서울숲리버">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구금호동4가힐스테이트서울숲리버");
  xhr.send();
