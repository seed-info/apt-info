...
<a style="color: blue;" href="/apt/서울특별시동대문구청량리동">[서울특별시동대문구 청량리동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=청량리동 한신">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구청량리동한신");
  xhr.send();
