...
<a style="color: green;" href="https://search.naver.com/search.naver?query=수색동 DMCSKVIEW">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시은평구수색동DMCSKVIEW");
  xhr.send();
