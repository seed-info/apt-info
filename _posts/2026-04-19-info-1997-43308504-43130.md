...
<a style="color: green;" href="https://search.naver.com/search.naver?query=대소원면대소리 한영(7,8동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도충주시대소원면대소리한영(7,8동)");
  xhr.send();
