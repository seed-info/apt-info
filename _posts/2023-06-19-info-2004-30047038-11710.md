...
<a style="color: green;" href="https://search.naver.com/search.naver?query=문정동 동궁리치웰문정(2차)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구문정동동궁리치웰문정(2차)");
  xhr.send();
