...
<a href="/apt/경기도동두천시생연동">[경기도동두천시 생연동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=생연동 에이스아파트(5차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시생연동에이스아파트(5차)");
  xhr.send();
