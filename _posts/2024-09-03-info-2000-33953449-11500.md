...
title: 수정
categories: [아파트정보]
permalink: /apt/서울특별시강서구화곡동수정
---

<a style="color: blue;" href="/apt/서울특별시강서구화곡동">< 서울특별시강서구 화곡동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=화곡동 수정">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강서구화곡동수정");
  xhr.send();
