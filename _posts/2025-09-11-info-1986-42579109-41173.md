...
<a style="color: green;" href="https://search.naver.com/search.naver?query=관양동 한미(A1,A2,B)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안양시동안구관양동한미(A1,A2,B)");
  xhr.send();
