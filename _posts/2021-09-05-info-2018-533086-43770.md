...
<a style="color: blue;" href="/apt/충청북도음성군대소면태생리">[충청북도음성군 대소면태생리 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=대소면태생리 대소웰메이드타운">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도음성군대소면태생리대소웰메이드타운");
  xhr.send();
