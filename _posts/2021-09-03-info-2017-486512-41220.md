...
<a href="/apt/경기도평택시서정동">[경기도평택시 서정동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=서정동 서정트인자리애2차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시서정동서정트인자리애2차");
  xhr.send();
