...
<a href="/apt/부산광역시서구토성동3가">[부산광역시서구 토성동3가 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=토성동3가 중보빌라">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시서구토성동3가중보빌라");
  xhr.send();
