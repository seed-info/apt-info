...
<a style="color: green;" href="https://search.naver.com/search.naver?query=성당동 성당태왕아너스메트로">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시달서구성당동성당태왕아너스메트로");
  xhr.send();
