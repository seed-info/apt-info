...
title: 로즈빌A
categories: [아파트정보]
permalink: /apt/서울특별시마포구공덕동로즈빌A
---

<a href="/apt/서울특별시마포구공덕동">[서울특별시마포구 공덕동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=공덕동 로즈빌A">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시마포구공덕동로즈빌A");
  xhr.send();
