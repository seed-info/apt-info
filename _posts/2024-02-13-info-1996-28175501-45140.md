...
<a style="color: green;" href="https://search.naver.com/search.naver?query=함열읍와리 금호(101동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도익산시함열읍와리금호(101동)");
  xhr.send();
