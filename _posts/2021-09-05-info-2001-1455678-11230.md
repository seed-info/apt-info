...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=이문동 이문삼성래미안아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구이문동이문삼성래미안아파트");
  xhr.send();
