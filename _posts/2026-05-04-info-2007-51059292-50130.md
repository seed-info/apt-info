...
title: 우성프라자
categories: [아파트정보]
permalink: /apt/제주특별자치도서귀포시동홍동우성프라자
---

<a style="color: blue;" href="/apt/제주특별자치도서귀포시동홍동">< 제주특별자치도서귀포시 동홍동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=동홍동 우성프라자">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시동홍동우성프라자");
  xhr.send();
