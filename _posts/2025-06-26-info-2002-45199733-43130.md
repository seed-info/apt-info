...
<a style="color: green;" href="https://search.naver.com/search.naver?query=호암동 호암리버빌(2단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도충주시호암동호암리버빌(2단지)");
  xhr.send();
