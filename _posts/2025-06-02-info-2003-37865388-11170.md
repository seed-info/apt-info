...
<a style="color: blue;" href="/apt/서울특별시용산구주성동">< 서울특별시용산구 주성동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=주성동 PRIMAVERAVILL">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구주성동PRIMAVERAVILL");
  xhr.send();
