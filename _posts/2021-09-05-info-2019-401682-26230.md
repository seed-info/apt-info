...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=범천동 골든팰리스더리치">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구범천동골든팰리스더리치");
  xhr.send();
