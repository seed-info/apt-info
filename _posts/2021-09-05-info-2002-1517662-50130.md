...
<a style="color: blue;" href="/apt/제주특별자치도서귀포시중문동">[제주특별자치도서귀포시 중문동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=중문동 중문미듬하나로">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시중문동중문미듬하나로");
  xhr.send();
