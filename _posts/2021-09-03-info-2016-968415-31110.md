...
<a href="/apt/울산광역시중구옥교동">[울산광역시중구 옥교동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=옥교동 한동리안느">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시중구옥교동한동리안느");
  xhr.send();
