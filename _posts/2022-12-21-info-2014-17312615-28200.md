...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서창동 서창센트라스아파트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시남동구서창동서창센트라스아파트");
  xhr.send();
