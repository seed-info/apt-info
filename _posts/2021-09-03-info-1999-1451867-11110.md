...
<a href="/apt/서울특별시종로구통인동">[서울특별시종로구 통인동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=통인동 효자">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구통인동효자");
  xhr.send();
