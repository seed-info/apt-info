...
<a style="color: green;" href="https://search.naver.com/search.naver?query=황학동 위너빌(Winnervill)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시중구황학동위너빌(Winnervill)");
  xhr.send();
