...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=구서동 구서벽산메가트리움">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구구서동구서벽산메가트리움");
  xhr.send();
