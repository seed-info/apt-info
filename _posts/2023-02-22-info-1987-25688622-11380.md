...
title: 수정가,나동
categories: [아파트정보]
permalink: /apt/서울특별시은평구수색동수정가,나동
---

<a style="color: blue;" href="/apt/서울특별시은평구수색동">< 서울특별시은평구 수색동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=수색동 수정가,나동">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시은평구수색동수정가,나동");
  xhr.send();
