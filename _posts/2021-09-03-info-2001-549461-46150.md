...
<a href="/apt/전라남도순천시서면선평리">[전라남도순천시 서면선평리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=서면선평리 선평배들마을주공">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도순천시서면선평리선평배들마을주공");
  xhr.send();
