...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=용해동 센트럴팰리체아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도목포시용해동센트럴팰리체아파트");
  xhr.send();
