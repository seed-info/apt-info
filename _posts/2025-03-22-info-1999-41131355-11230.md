...
title: 클래식타워
categories: [아파트정보]
permalink: /apt/서울특별시동대문구답십리동클래식타워
---

<a style="color: blue;" href="/apt/서울특별시동대문구답십리동">< 서울특별시동대문구 답십리동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=답십리동 클래식타워">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구답십리동클래식타워");
  xhr.send();
