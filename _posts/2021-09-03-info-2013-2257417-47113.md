...
<a href="/apt/경상북도포항시북구장성동">[경상북도포항시북구 장성동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=장성동 해피플러스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도포항시북구장성동해피플러스");
  xhr.send();
