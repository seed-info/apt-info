...
<a style="color: green;" href="https://search.naver.com/search.naver?query=우면동 엘에이치서초5단지(토지임대부아파트)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구우면동엘에이치서초5단지(토지임대부아파트)");
  xhr.send();
