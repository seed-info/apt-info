...
<a href="/apt/서울특별시용산구용산동2가">[서울특별시용산구 용산동2가 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=용산동2가 용암한신">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구용산동2가용암한신");
  xhr.send();
