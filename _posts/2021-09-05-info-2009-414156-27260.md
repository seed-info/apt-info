...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=상동 수성동일하이빌레이크시티">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구상동수성동일하이빌레이크시티");
  xhr.send();
