...
<a style="color: green;" href="https://search.naver.com/search.naver?query=청담동 청담힐(에이동)진도(비동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강남구청담동청담힐(에이동)진도(비동)");
  xhr.send();
