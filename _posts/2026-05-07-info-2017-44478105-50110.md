...
<a style="color: green;" href="https://search.naver.com/search.naver?query=삼양이동 엔에이치에프제주삼화1단지">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시삼양이동엔에이치에프제주삼화1단지");
  xhr.send();
