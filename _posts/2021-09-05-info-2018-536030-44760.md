...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=규암면외리 부여코아루더퍼스트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도부여군규암면외리부여코아루더퍼스트");
  xhr.send();
