...
<a style="color: green;" href="https://search.naver.com/search.naver?query=선부동 선부더빌(SunbuTheVille)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안산시단원구선부동선부더빌(SunbuTheVille)");
  xhr.send();
