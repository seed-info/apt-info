...
<a style="color: blue;" href="/apt/부산광역시서구토성동5가">[부산광역시서구 토성동5가 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=토성동5가 서원스위트홈">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시서구토성동5가서원스위트홈");
  xhr.send();
