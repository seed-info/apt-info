...
<a style="color: green;" href="https://search.naver.com/search.naver?query=강동동 강서자이에코델타">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시강서구강동동강서자이에코델타");
  xhr.send();
