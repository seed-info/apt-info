...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=판교동 판교원마을6단지(진원로제비앙)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도성남시분당구판교동판교원마을6단지(진원로제비앙)");
  xhr.send();
