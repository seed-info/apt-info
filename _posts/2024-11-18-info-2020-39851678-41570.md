...
title: 한강메트로자이2단지
categories: [아파트정보]
permalink: /apt/경기도김포시경기김포시한강메트로자이2단지
---

<a style="color: blue;" href="/apt/경기도김포시경기김포시">< 경기도김포시 경기김포시 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=경기김포시 한강메트로자이2단지">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도김포시경기김포시한강메트로자이2단지");
  xhr.send();
