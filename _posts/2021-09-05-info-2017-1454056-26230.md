...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=부암동 서면동일파크스위트2차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구부암동서면동일파크스위트2차");
  xhr.send();
