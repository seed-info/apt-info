...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서울종로구 종로유케이201">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구서울종로구종로유케이201");
  xhr.send();
