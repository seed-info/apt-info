...
2021년 09월 01일 <a href="/apt/경상북도영주시">경상북도영주시</a> 문수면승문리 실거래 정보
...
<div style="margin-top: 50px; margin-bottom: 13px">지난 일주일 실거래 내역</div>
  ...
  <table style="width: 100%; margin-bottom: 1px">
      ...
      <tr class="child" style="display: none">
        ...
        <table>
          <tr>
            <td colspan="4" style="font-weight: bold;"><a href="https://search.naver.com/search.naver?query=실거래정보없음">실거래정보없음</a> &nbsp;&nbsp;&nbsp; <a style="color: blue; font-size: smaller;" href="/apt/{real_region}문수면승문리{name_without_space}">[실거래상세정보]</a></td>            
          </tr>
