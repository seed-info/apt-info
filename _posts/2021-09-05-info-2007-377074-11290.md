...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=하월곡동 성북힐스테이트(102동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구하월곡동성북힐스테이트(102동)");
  xhr.send();
