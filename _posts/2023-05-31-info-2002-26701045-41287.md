...
<a style="color: green;" href="https://search.naver.com/search.naver?query=대화동 킨텍스자이(1단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도고양시일산서구대화동킨텍스자이(1단지)");
  xhr.send();
