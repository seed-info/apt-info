...
<a href="/apt/경기도화성시반월동">[경기도화성시 반월동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=반월동 반달마을푸르지오">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도화성시반월동반달마을푸르지오");
  xhr.send();
