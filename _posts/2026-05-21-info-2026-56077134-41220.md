...
<a style="color: green;" href="https://search.naver.com/search.naver?query=가재동 지제역반도체밸리풍경채어바니티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시가재동지제역반도체밸리풍경채어바니티");
  xhr.send();
