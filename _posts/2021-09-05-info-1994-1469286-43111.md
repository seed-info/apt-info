...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=용암동 청주용암주공1단지아파트(해누리)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도청주시상당구용암동청주용암주공1단지아파트(해누리)");
  xhr.send();
