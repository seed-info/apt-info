...
<a href="/apt/경기도구리시교문동">[경기도구리시 교문동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=교문동 구리(우성)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도구리시교문동구리(우성)");
  xhr.send();
