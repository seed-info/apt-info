...
<a href="/apt/경기도김포시풍무동">[경기도김포시 풍무동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=풍무동 양도마을(서해그랑블)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도김포시풍무동양도마을(서해그랑블)");
  xhr.send();
