...
title: 동일3차
categories: [아파트정보]
permalink: /apt/서울특별시서대문구홍제동동일3차
---

<a href="/apt/서울특별시서대문구홍제동">[서울특별시서대문구 홍제동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=홍제동 동일3차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구홍제동동일3차");
  xhr.send();
