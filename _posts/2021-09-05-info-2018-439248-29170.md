...
<a style="color: blue;" href="/apt/광주광역시북구연제동">[광주광역시북구 연제동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=연제동 연제동골드클래스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시북구연제동연제동골드클래스");
  xhr.send();
