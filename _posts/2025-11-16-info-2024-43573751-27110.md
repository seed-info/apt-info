...
<a style="color: green;" href="https://search.naver.com/search.naver?query=태평로3가 힐스테이트달성공원역">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시중구태평로3가힐스테이트달성공원역");
  xhr.send();
