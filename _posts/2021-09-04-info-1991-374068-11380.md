...
<a href="/apt/서울특별시은평구구산동">[서울특별시은평구 구산동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=구산동 동익파크(355-95)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시은평구구산동동익파크(355-95)");
  xhr.send();
