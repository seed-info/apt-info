...
layout: post
comments: true
title: 울산명촌효성해링턴플레이스(81블록)
categories: [아파트정보]
permalink: /apt/울산광역시북구명촌동울산명촌효성해링턴플레이스(81블록)
---

<a href="/apt/울산광역시북구명촌동">[울산광역시북구 명촌동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=명촌동 울산명촌효성해링턴플레이스(81블록)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구명촌동울산명촌효성해링턴플레이스(81블록)");
  xhr.send();
