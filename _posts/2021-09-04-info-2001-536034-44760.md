...
<a href="/apt/충청남도부여군규암면합송리">[충청남도부여군 규암면합송리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=규암면합송리 규암강산">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도부여군규암면합송리규암강산");
  xhr.send();
