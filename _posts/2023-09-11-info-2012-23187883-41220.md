...
<a style="color: green;" href="https://search.naver.com/search.naver?query=비전동 평택센트럴해링턴플레이스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시비전동평택센트럴해링턴플레이스");
  xhr.send();
