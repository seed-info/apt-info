...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=홍성읍남장리 미성아파트(A,B동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도홍성군홍성읍남장리미성아파트(A,B동)");
  xhr.send();
