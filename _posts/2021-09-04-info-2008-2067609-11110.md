...
<a href="/apt/서울특별시종로구사직동">[서울특별시종로구 사직동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=사직동 광화문풍림스페이스본(106동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구사직동광화문풍림스페이스본(106동)");
  xhr.send();
