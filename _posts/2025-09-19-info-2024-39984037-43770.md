...
<a style="color: green;" href="https://search.naver.com/search.naver?query=대소면성본리 음성푸르지오더퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도음성군대소면성본리음성푸르지오더퍼스트");
  xhr.send();
