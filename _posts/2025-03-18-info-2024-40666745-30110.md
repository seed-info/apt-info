...
<a style="color: green;" href="https://search.naver.com/search.naver?query=가양동 힐스테이트가양더와이즈">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시동구가양동힐스테이트가양더와이즈");
  xhr.send();
