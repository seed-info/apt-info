...
<a href="/apt/서울특별시성동구행당동">[서울특별시성동구 행당동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=행당동 서울숲행당푸르지오">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구행당동서울숲행당푸르지오");
  xhr.send();
