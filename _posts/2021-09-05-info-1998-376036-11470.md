...
title: 일신파스텔
categories: [아파트정보]
permalink: /apt/서울특별시양천구목동일신파스텔
---

<a style="color: blue;" href="/apt/서울특별시양천구목동">[서울특별시양천구 목동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=목동 일신파스텔">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시양천구목동일신파스텔");
  xhr.send();
