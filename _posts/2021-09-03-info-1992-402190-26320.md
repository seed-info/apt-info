...
<a href="/apt/부산광역시북구만덕동">[부산광역시북구 만덕동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=만덕동 럭키2">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시북구만덕동럭키2");
  xhr.send();
