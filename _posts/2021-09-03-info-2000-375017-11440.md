...
<a href="/apt/서울특별시마포구합정동">[서울특별시마포구 합정동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=합정동 장미(466-0)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시마포구합정동장미(466-0)");
  xhr.send();
