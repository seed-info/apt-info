...
title: 홍제역해링턴플레이스
categories: [아파트정보]
permalink: /apt/서울특별시서대문구홍제역해링턴플레이스
---

<a style="color: blue;" href="/apt/서울특별시서대문구">< 서울특별시서대문구  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 홍제역해링턴플레이스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구홍제역해링턴플레이스");
  xhr.send();
