...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=정릉동 정릉한일유앤아이">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구정릉동정릉한일유앤아이");
  xhr.send();
