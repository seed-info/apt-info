...
<a style="color: green;" href="https://search.naver.com/search.naver?query=자곡동 엘에이치강남힐스테이트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강남구자곡동엘에이치강남힐스테이트");
  xhr.send();
