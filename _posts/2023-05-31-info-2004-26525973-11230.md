...
<a style="color: green;" href="https://search.naver.com/search.naver?query=장안동 대성하이빌(B동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구장안동대성하이빌(B동)");
  xhr.send();
