...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서울중구 LIG서울역리가">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시중구서울중구LIG서울역리가");
  xhr.send();
