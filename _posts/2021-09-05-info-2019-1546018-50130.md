...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=표선면표선리 세베스트아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시표선면표선리세베스트아파트");
  xhr.send();
