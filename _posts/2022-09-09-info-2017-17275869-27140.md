...
<a style="color: blue;" href="/apt/대구광역시동구신서동">< 대구광역시동구 신서동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=신서동 각산역더뉴클래스3차">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시동구신서동각산역더뉴클래스3차");
  xhr.send();
