...
title: 퍼스트클래스
categories: [아파트정보]
permalink: /apt/부산광역시부산진구가야동퍼스트클래스
---

<a style="color: blue;" href="/apt/부산광역시부산진구가야동">< 부산광역시부산진구 가야동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=가야동 퍼스트클래스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구가야동퍼스트클래스");
  xhr.send();
