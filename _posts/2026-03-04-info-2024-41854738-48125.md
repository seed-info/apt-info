...
<a style="color: green;" href="https://search.naver.com/search.naver?query=교방동 창원푸르지오더플래티넘1단지">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도창원시마산합포구교방동창원푸르지오더플래티넘1단지");
  xhr.send();
