...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=백석동 백송마을(두산)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도고양시일산동구백석동백송마을(두산)");
  xhr.send();
