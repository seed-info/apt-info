...
<a style="color: blue;" href="/apt/대구광역시중구서성로1가">< 대구광역시중구 서성로1가 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서성로1가 중앙로역푸르지오더센트럴">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시중구서성로1가중앙로역푸르지오더센트럴");
  xhr.send();
