...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=노은동 열매마을9단지(금성백조)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시유성구노은동열매마을9단지(금성백조)");
  xhr.send();
