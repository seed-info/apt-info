...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=장유동 율하자이힐스테이트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도김해시장유동율하자이힐스테이트");
  xhr.send();
