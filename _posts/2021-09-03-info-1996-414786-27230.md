...
<a href="/apt/대구광역시북구복현동">[대구광역시북구 복현동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=복현동 복현서한이다음">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시북구복현동복현서한이다음");
  xhr.send();
