...
title: 리치팰리스
categories: [아파트정보]
permalink: /apt/서울특별시서초구방배동리치팰리스
---

<a href="/apt/서울특별시서초구방배동">[서울특별시서초구 방배동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=방배동 리치팰리스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구방배동리치팰리스");
  xhr.send();
