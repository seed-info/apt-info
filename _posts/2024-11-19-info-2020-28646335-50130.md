...
<a style="color: green;" href="https://search.naver.com/search.naver?query=대정읍상모리 상모채움">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시대정읍상모리상모채움");
  xhr.send();
