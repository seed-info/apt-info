...
<a href="/apt/서울특별시동작구동작동">[서울특별시동작구 동작동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=동작동 이수교KCC스위첸">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구동작동이수교KCC스위첸");
  xhr.send();
