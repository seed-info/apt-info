...
<a style="color: green;" href="https://search.naver.com/search.naver?query=학동 신영루체클래식(784-1)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시동구학동신영루체클래식(784-1)");
  xhr.send();
