...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=당동 남광팰리스(9B-5L)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도군포시당동남광팰리스(9B-5L)");
  xhr.send();
