...
<a style="color: green;" href="https://search.naver.com/search.naver?query=간석동 삼마TOP-Class(간석탑클래스)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시남동구간석동삼마TOP-Class(간석탑클래스)");
  xhr.send();
