...
<a style="color: green;" href="https://search.naver.com/search.naver?query=덕포동 대하덕포(1호동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시사상구덕포동대하덕포(1호동)");
  xhr.send();
