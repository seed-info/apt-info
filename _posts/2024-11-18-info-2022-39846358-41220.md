...
title: 지제역더샵센트럴시티
categories: [아파트정보]
permalink: /apt/경기도평택시지제역더샵센트럴시티
---

<a style="color: blue;" href="/apt/경기도평택시">< 경기도평택시  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 지제역더샵센트럴시티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시지제역더샵센트럴시티");
  xhr.send();
