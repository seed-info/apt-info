...
<a href="/apt/경기도화성시우정읍조암리">[경기도화성시 우정읍조암리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=우정읍조암리 신태영(아)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도화성시우정읍조암리신태영(아)");
  xhr.send();
