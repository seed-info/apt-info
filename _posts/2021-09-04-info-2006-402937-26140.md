...
title: 해오름
categories: [아파트정보]
permalink: /apt/부산광역시서구토성동5가해오름
---

<a href="/apt/부산광역시서구토성동5가">[부산광역시서구 토성동5가 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=토성동5가 해오름">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시서구토성동5가해오름");
  xhr.send();
