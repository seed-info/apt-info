...
title: 용산더프라임
categories: [아파트정보]
permalink: /apt/서울특별시용산구서울용산구,서울중구용산더프라임
---

<a style="color: blue;" href="/apt/서울특별시용산구서울용산구,서울중구">< 서울특별시용산구 서울용산구,서울중구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서울용산구,서울중구 용산더프라임">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구서울용산구,서울중구용산더프라임");
  xhr.send();
