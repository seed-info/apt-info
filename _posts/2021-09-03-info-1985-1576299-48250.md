...
<a href="/apt/경상남도김해시서상동">[경상남도김해시 서상동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=서상동 범환맨션">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도김해시서상동범환맨션");
  xhr.send();
