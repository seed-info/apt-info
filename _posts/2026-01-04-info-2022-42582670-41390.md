...
<a style="color: green;" href="https://search.naver.com/search.naver?query=장현동 엘에이치트리플센텀">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도시흥시장현동엘에이치트리플센텀");
  xhr.send();
