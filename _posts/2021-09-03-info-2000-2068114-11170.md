...
<a href="/apt/서울특별시용산구보광동">[서울특별시용산구 보광동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=보광동 리버빌(삼성)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구보광동리버빌(삼성)");
  xhr.send();
