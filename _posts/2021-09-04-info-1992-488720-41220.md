...
<a href="/apt/경기도평택시이충동">[경기도평택시 이충동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=이충동 현대(이충)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시이충동현대(이충)");
  xhr.send();
