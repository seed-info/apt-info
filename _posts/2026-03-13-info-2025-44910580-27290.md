...
<a style="color: green;" href="https://search.naver.com/search.naver?query=두류동 두류역서한포레스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시달서구두류동두류역서한포레스트");
  xhr.send();
