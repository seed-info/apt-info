...
<a style="color: green;" href="https://search.naver.com/search.naver?query=신정동 래미안목동아델리체(1326-1)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시양천구신정동래미안목동아델리체(1326-1)");
  xhr.send();
