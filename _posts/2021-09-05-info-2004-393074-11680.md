...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=논현동 스위트캐슬레지던스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강남구논현동스위트캐슬레지던스");
  xhr.send();
