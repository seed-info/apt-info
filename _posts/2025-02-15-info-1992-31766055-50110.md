...
<a style="color: green;" href="https://search.naver.com/search.naver?query=용담이동 용두암현대3">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시용담이동용두암현대3");
  xhr.send();
