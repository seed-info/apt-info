...
<a style="color: blue;" href="/apt/경기도평택시지제동">< 경기도평택시 지제동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=지제동 지제역더샵센트럴시티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시지제동지제역더샵센트럴시티");
  xhr.send();
