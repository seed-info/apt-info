...
<a href="/apt/울산광역시남구달동">[울산광역시남구 달동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=달동 번영로코아루더클래식">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시남구달동번영로코아루더클래식");
  xhr.send();
