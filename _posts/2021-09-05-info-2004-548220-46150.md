...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=연향동 율산에코지오아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도순천시연향동율산에코지오아파트");
  xhr.send();
