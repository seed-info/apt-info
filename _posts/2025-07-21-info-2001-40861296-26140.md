...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서대신동3가 대신썬빌리지B">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시서구서대신동3가대신썬빌리지B");
  xhr.send();
