...
<a style="color: green;" href="https://search.naver.com/search.naver?query=용해동 (구)용해(205-24)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도목포시용해동(구)용해(205-24)");
  xhr.send();
