...
<a href="/apt/대전광역시유성구반석동">[대전광역시유성구 반석동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=반석동 반석더샵">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시유성구반석동반석더샵");
  xhr.send();
