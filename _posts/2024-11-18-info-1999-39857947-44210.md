...
title: 현대(예천)
categories: [아파트정보]
permalink: /apt/충청남도서산시현대(예천)
---

<a style="color: blue;" href="/apt/충청남도서산시">< 충청남도서산시  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 현대(예천)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도서산시현대(예천)");
  xhr.send();
