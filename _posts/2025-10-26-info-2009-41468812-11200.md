...
<a style="color: green;" href="https://search.naver.com/search.naver?query=성수동2가 서울숲힐스테이트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구성수동2가서울숲힐스테이트");
  xhr.send();
