...
<a href="/apt/인천광역시동구송현동">[인천광역시동구 송현동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=송현동 송현1차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시동구송현동송현1차");
  xhr.send();
