...
<a style="color: green;" href="https://search.naver.com/search.naver?query=송악읍기지시리 당진푸르지오클라테르">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도당진시송악읍기지시리당진푸르지오클라테르");
  xhr.send();
