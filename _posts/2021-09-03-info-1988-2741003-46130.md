...
<a href="/apt/전라남도여수시연등동">[전라남도여수시 연등동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=연등동 성학">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시연등동성학");
  xhr.send();
