...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=태전동 힐스테이트태전(C5,1507~1514동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도광주시태전동힐스테이트태전(C5,1507~1514동)");
  xhr.send();
