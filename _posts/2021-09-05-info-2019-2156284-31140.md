...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=야음동 힐스테이트수암(2단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시남구야음동힐스테이트수암(2단지)");
  xhr.send();
