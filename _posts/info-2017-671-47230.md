...
('33,500', '2021-03-26', '야사동', '한신더휴영천퍼스트', '103.204', '15')
('65', '2018-09-11', '야사동', '한신더휴영천퍼스트', '84.4707', '3')
...
<table cellpadding='10' cellspacing='10px' border='1' style='border-collapse:collapse; border:1px gray solid;'>
    ...
    <tr>
      ...
      <td style='padding-top: 2px; padding-bottom: 2px; padding-left: 10px; padding-right: 10px; text-align: center;'>84.9389</td>
