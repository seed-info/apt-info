...
<a href="/apt/경기도안산시상록구본오동">[경기도안산시상록구 본오동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=본오동 보라팰리스(948-14)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안산시상록구본오동보라팰리스(948-14)");
  xhr.send();
