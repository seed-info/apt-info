...
<a style="color: green;" href="https://search.naver.com/search.naver?query=지산동 지산서한이다음아파트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구지산동지산서한이다음아파트");
  xhr.send();
