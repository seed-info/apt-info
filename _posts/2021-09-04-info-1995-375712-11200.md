...
<a href="/apt/서울특별시성동구용답동">[서울특별시성동구 용답동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=용답동 중앙하이츠">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구용답동중앙하이츠");
  xhr.send();
