...
title: 모라벽산
categories: [아파트정보]
permalink: /apt/부산광역시사상구부산사상구모라벽산
---

<a style="color: blue;" href="/apt/부산광역시사상구부산사상구">< 부산광역시사상구 부산사상구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=부산사상구 모라벽산">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시사상구부산사상구모라벽산");
  xhr.send();
