...
<a style="color: green;" href="https://search.naver.com/search.naver?query=구로동 (777-3)두암호은리버빌">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시구로구구로동(777-3)두암호은리버빌");
  xhr.send();
