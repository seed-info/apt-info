...
<a style="color: green;" href="https://search.naver.com/search.naver?query=계림동 두산위브3차(두산위브더파크)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시동구계림동두산위브3차(두산위브더파크)");
  xhr.send();
