...
<a style="color: blue;" href="/apt/서울특별시성동구옥수동">< 서울특별시성동구 옥수동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=옥수동 옥수어울림">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구옥수동옥수어울림");
  xhr.send();
