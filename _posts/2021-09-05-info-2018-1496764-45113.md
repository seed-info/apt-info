...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=만성동 중흥에스클래스더퍼스트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도전주시덕진구만성동중흥에스클래스더퍼스트");
  xhr.send();
