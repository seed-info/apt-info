...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=연지동 연지동삼정그린코아">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구연지동연지동삼정그린코아");
  xhr.send();
