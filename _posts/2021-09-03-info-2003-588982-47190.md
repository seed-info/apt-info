...
<a href="/apt/경상북도구미시오태동">[경상북도구미시 오태동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=오태동 행복의아침101">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도구미시오태동행복의아침101");
  xhr.send();
