...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=반포동 현대반포빌라트B">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구반포동현대반포빌라트B");
  xhr.send();
