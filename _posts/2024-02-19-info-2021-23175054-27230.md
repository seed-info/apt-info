...
<a style="color: blue;" href="/apt/대구광역시북구복현동">< 대구광역시북구 복현동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=복현동 복현아이파크">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시북구복현동복현아이파크");
  xhr.send();
