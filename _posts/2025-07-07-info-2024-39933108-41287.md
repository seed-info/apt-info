...
<a style="color: green;" href="https://search.naver.com/search.naver?query=덕이동 일산푸르지오더센트럴">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도고양시일산서구덕이동일산푸르지오더센트럴");
  xhr.send();
