...
title: 명지해드는터
categories: [아파트정보]
permalink: /apt/서울특별시서초구방배동명지해드는터
---

<a style="color: blue;" href="/apt/서울특별시서초구방배동">< 서울특별시서초구 방배동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=방배동 명지해드는터">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구방배동명지해드는터");
  xhr.send();
