...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=나성동 리베라아이누리(2-2)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시나성동리베라아이누리(2-2)");
  xhr.send();
