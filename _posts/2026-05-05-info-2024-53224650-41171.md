...
<a style="color: green;" href="https://search.naver.com/search.naver?query=석수동 미영팰리스(337-1)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안양시만안구석수동미영팰리스(337-1)");
  xhr.send();
