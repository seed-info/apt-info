...
<a style="color: green;" href="https://search.naver.com/search.naver?query=현덕면인광리 한일(A,B)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시현덕면인광리한일(A,B)");
  xhr.send();
