...
title: 상훈(B동)
categories: [아파트정보]
permalink: /apt/경기도군포시당정동상훈(B동)
---

<a style="color: blue;" href="/apt/경기도군포시당정동">< 경기도군포시 당정동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=당정동 상훈(B동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도군포시당정동상훈(B동)");
  xhr.send();
