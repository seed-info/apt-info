...
<table>
  <tr>
    <td colspan="4" style="font-weight: bold;"><a href="https://search.naver.com/search.naver?query=율촌면조화리 조화(A,B,C)">조화(A,B,C)</a> &nbsp;&nbsp;&nbsp; <a style="color: blue;" href="/apt/전라남도여수시율촌면조화리조화(A,B,C)">[실거래상세분석]</a></td>
  </tr>
