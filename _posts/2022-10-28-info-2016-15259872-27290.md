...
<a style="color: green;" href="https://search.naver.com/search.naver?query=죽전동 태영팰리스(101동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시달서구죽전동태영팰리스(101동)");
  xhr.send();
