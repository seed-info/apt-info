...
<a style="color: blue;" href="/apt/인천광역시계양구용종동">[인천광역시계양구 용종동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=용종동 초정마을(두산)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시계양구용종동초정마을(두산)");
  xhr.send();
