...
<a href="/apt/서울특별시동작구본동">[서울특별시동작구 본동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=본동 신동아">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구본동신동아");
  xhr.send();
