...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=청계동 롯데캐슬알바트로스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도화성시청계동롯데캐슬알바트로스");
  xhr.send();
