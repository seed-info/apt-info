...
<a style="color: green;" href="https://search.naver.com/search.naver?query=신정동 울산문수로두산위브더제니스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시남구신정동울산문수로두산위브더제니스");
  xhr.send();
