...
<a href="/apt/경기도평택시진위면견산리">[경기도평택시 진위면견산리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=진위면견산리 경원">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시진위면견산리경원");
  xhr.send();
