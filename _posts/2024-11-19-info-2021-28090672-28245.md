...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서운동 계양효성해링턴플레이스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시계양구서운동계양효성해링턴플레이스");
  xhr.send();
