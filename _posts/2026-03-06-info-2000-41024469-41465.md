...
<a style="color: green;" href="https://search.naver.com/search.naver?query=풍덕천동 이스턴팰리스EasternPalace">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도용인시수지구풍덕천동이스턴팰리스EasternPalace");
  xhr.send();
