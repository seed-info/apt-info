...
title: 일신상가
categories: [아파트정보]
permalink: /apt/경상북도안동시천리동일신상가
---

<a href="/apt/경상북도안동시천리동">[경상북도안동시 천리동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=천리동 일신상가">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도안동시천리동일신상가");
  xhr.send();
