...
<a style="color: green;" href="https://search.naver.com/search.naver?query=간석동 간석리페(2차)도시형생활주택">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시남동구간석동간석리페(2차)도시형생활주택");
  xhr.send();
