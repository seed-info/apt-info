...
<a href="/apt/서울특별시영등포구도림동">[서울특별시영등포구 도림동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=도림동 도림청구">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시영등포구도림동도림청구");
  xhr.send();
