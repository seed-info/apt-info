...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=반석동 반석마을6단지(삼부르네상스2단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시유성구반석동반석마을6단지(삼부르네상스2단지)");
  xhr.send();
