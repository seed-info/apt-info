...
<a style="color: green;" href="https://search.naver.com/search.naver?query=수정동 수정(1161-7)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동구수정동수정(1161-7)");
  xhr.send();
