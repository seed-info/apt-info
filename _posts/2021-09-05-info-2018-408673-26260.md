...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=사직동 사직역삼정그린코아더베스트2차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동래구사직동사직역삼정그린코아더베스트2차");
  xhr.send();
