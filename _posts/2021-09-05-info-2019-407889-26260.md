...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=온천동 동래효성해링턴플레이스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동래구온천동동래효성해링턴플레이스");
  xhr.send();
