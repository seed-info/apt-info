...
title: 래미안송파파인탑
categories: [아파트정보]
permalink: /apt/서울특별시송파구서울송파구래미안송파파인탑
---

<a style="color: blue;" href="/apt/서울특별시송파구서울송파구">< 서울특별시송파구 서울송파구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서울송파구 래미안송파파인탑">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구서울송파구래미안송파파인탑");
  xhr.send();
