...
<a style="color: green;" href="https://search.naver.com/search.naver?query=일도이동 정우신산캐슬">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시일도이동정우신산캐슬");
  xhr.send();
