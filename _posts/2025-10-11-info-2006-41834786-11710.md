...
<a style="color: green;" href="https://search.naver.com/search.naver?query=방이동 파라다이스빌(40-0)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구방이동파라다이스빌(40-0)");
  xhr.send();
