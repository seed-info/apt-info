...
title: 센트로파크B동
categories: [아파트정보]
permalink: /apt/대구광역시동구입석동센트로파크B동
---

<a style="color: blue;" href="/apt/대구광역시동구입석동">< 대구광역시동구 입석동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=입석동 센트로파크B동">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시동구입석동센트로파크B동");
  xhr.send();
