...
title: 시영
categories: [아파트정보]
permalink: /apt/부산광역시부산진구개금동시영
---

<a href="/apt/부산광역시부산진구개금동">[부산광역시부산진구 개금동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=개금동 시영">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구개금동시영");
  xhr.send();
