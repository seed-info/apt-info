...
<a href="/apt/경상북도안동시송현동">[경상북도안동시 송현동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=송현동 청구송현하이츠">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도안동시송현동청구송현하이츠");
  xhr.send();
