...
<a href="/apt/전라남도여수시여서동">[전라남도여수시 여서동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=여서동 여서주공1차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시여서동여서주공1차");
  xhr.send();
