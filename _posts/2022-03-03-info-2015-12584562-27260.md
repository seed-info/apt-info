...
title: 수성레이크뷰
categories: [아파트정보]
permalink: /apt/대구광역시수성구지산동수성레이크뷰
---

<a style="color: blue;" href="/apt/대구광역시수성구지산동">< 대구광역시수성구 지산동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=지산동 수성레이크뷰">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구지산동수성레이크뷰");
  xhr.send();
