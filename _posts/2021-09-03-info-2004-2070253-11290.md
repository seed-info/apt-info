...
title: 양지
categories: [아파트정보]
permalink: /apt/서울특별시성북구동소문동4가양지
---

<a href="/apt/서울특별시성북구동소문동4가">[서울특별시성북구 동소문동4가 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=동소문동4가 양지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구동소문동4가양지");
  xhr.send();
