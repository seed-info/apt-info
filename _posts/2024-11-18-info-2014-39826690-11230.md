...
title: 래미안크레시티
categories: [아파트정보]
permalink: /apt/서울특별시동대문구서울동대문구래미안크레시티
---

<a style="color: blue;" href="/apt/서울특별시동대문구서울동대문구">< 서울특별시동대문구 서울동대문구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서울동대문구 래미안크레시티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구서울동대문구래미안크레시티");
  xhr.send();
