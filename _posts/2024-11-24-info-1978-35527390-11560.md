...
<a style="color: green;" href="https://search.naver.com/search.naver?query=여의도동 광장(1,2동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시영등포구여의도동광장(1,2동)");
  xhr.send();
