...
title: 범일역삼정그린코아더시티
categories: [아파트정보]
permalink: /apt/부산광역시동구범일동범일역삼정그린코아더시티
---

<a style="color: blue;" href="/apt/부산광역시동구범일동">< 부산광역시동구 범일동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=범일동 범일역삼정그린코아더시티">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동구범일동범일역삼정그린코아더시티");
  xhr.send();
