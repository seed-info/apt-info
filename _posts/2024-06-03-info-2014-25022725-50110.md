...
<a style="color: green;" href="https://search.naver.com/search.naver?query=오라이동 미듬아뜨리에">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시오라이동미듬아뜨리에");
  xhr.send();
