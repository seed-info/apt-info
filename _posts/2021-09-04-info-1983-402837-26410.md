...
title: 신동아
categories: [아파트정보]
permalink: /apt/부산광역시금정구서동신동아
---

<a href="/apt/부산광역시금정구서동">[부산광역시금정구 서동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=서동 신동아">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구서동신동아");
  xhr.send();
