...
title: 태화
categories: [아파트정보]
permalink: /apt/인천광역시미추홀구용현동태화
---

<a href="/apt/인천광역시미추홀구용현동">[인천광역시미추홀구 용현동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=용현동 태화">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시미추홀구용현동태화");
  xhr.send();
