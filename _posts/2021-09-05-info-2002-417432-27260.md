...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=수성동4가 수성우방팔레스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구수성동4가수성우방팔레스");
  xhr.send();
