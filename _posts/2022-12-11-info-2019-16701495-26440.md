...
<a style="color: blue;" href="/apt/부산광역시강서구명지동">< 부산광역시강서구 명지동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=명지동 더에듀팰리스부영">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시강서구명지동더에듀팰리스부영");
  xhr.send();
