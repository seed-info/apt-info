...
<a href="/apt/경기도평택시용이동">[경기도평택시 용이동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=용이동 e편한세상평택용이2단지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시용이동e편한세상평택용이2단지");
  xhr.send();
