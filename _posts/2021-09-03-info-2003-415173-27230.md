...
<a href="/apt/대구광역시북구서변동">[대구광역시북구 서변동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=서변동 동서리치모아">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시북구서변동동서리치모아");
  xhr.send();
