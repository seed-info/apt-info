...
title: 교수(A)
categories: [아파트정보]
permalink: /apt/서울특별시서대문구홍은동교수(A)
---

<a style="color: blue;" href="/apt/서울특별시서대문구홍은동">< 서울특별시서대문구 홍은동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=홍은동 교수(A)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구홍은동교수(A)");
  xhr.send();
