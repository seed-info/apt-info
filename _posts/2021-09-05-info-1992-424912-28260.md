...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=마전동 유호A단지(A1,A2동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시서구마전동유호A단지(A1,A2동)");
  xhr.send();
