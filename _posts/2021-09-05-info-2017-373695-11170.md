...
<a style="color: blue;" href="/apt/서울특별시용산구한강로2가">[서울특별시용산구 한강로2가 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=한강로2가 용산푸르지오써밋(420)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구한강로2가용산푸르지오써밋(420)");
  xhr.send();
