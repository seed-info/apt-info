...
title: 킹스매너
categories: [아파트정보]
permalink: /apt/서울특별시종로구내수동킹스매너
---

<a href="/apt/서울특별시종로구내수동">[서울특별시종로구 내수동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=내수동 킹스매너">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구내수동킹스매너");
  xhr.send();
