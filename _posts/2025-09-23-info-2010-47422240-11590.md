...
<a style="color: green;" href="https://search.naver.com/search.naver?query=상도동 종인아네스트(409-3)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구상도동종인아네스트(409-3)");
  xhr.send();
