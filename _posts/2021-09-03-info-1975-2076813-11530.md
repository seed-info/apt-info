...
<a href="/apt/서울특별시구로구개봉동">[서울특별시구로구 개봉동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=개봉동 왕궁">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시구로구개봉동왕궁");
  xhr.send();
