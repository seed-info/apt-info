...
<a style="color: blue;" href="/apt/경기도양평군개군면하자포리">< 경기도양평군 개군면하자포리 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=개군면하자포리 양평비바체">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도양평군개군면하자포리양평비바체");
  xhr.send();
