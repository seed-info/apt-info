...
title: 반석블레스
categories: [아파트정보]
permalink: /apt/경기도구리시수택동반석블레스
---

<a style="color: blue;" href="/apt/경기도구리시수택동">< 경기도구리시 수택동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=수택동 반석블레스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도구리시수택동반석블레스");
  xhr.send();
