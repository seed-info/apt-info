...
<a href="/apt/대구광역시달서구송현동">[대구광역시달서구 송현동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=송현동 송현제림">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시달서구송현동송현제림");
  xhr.send();
