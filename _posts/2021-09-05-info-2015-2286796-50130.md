...
title: 해누리
categories: [아파트정보]
permalink: /apt/제주특별자치도서귀포시대정읍상모리해누리
---

<a style="color: blue;" href="/apt/제주특별자치도서귀포시대정읍상모리">[제주특별자치도서귀포시 대정읍상모리 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=대정읍상모리 해누리">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시대정읍상모리해누리");
  xhr.send();
