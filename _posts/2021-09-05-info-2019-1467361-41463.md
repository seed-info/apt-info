...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=보라동 용인보라효성해링턴플레이스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도용인시기흥구보라동용인보라효성해링턴플레이스");
  xhr.send();
