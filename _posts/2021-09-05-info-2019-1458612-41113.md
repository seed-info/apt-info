...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=호매실동 호매실금호어울림에듀포레">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도수원시권선구호매실동호매실금호어울림에듀포레");
  xhr.send();
