...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=송죽동 대성(A,B,C)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도수원시장안구송죽동대성(A,B,C)");
  xhr.send();
