...
title: 리치스
categories: [아파트정보]
permalink: /apt/서울특별시서초구양재동리치스
---

<a style="color: blue;" href="/apt/서울특별시서초구양재동">< 서울특별시서초구 양재동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=양재동 리치스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구양재동리치스");
  xhr.send();
