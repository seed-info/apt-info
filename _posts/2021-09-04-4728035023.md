...
2021년 09월 04일 <a href="/apt/경상북도문경시">경상북도문경시</a> 동로면수평리 실거래 정보
...
<table>
  <tr>
    <td colspan="4" style="font-weight: bold;"><a href="/apt/경상북도문경시동로면수평리{name_without_space}">오늘 등록된 실거래 정보가 없습니다</a> &nbsp;&nbsp;&nbsp; <a style="color: blue; font-size: smaller;" href="/apt/경상북도문경시동로면수평리{name_without_space}">[실거래상세정보]</a></td>
  </tr>
