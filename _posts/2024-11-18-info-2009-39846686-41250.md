...
title: 신창비바패밀리(1단지)
categories: [아파트정보]
permalink: /apt/경기도동두천시경기동두천시신창비바패밀리(1단지)
---

<a style="color: blue;" href="/apt/경기도동두천시경기동두천시">< 경기도동두천시 경기동두천시 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=경기동두천시 신창비바패밀리(1단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시경기동두천시신창비바패밀리(1단지)");
  xhr.send();
