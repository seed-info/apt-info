...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=한강로2가 벽산메가트리움">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구한강로2가벽산메가트리움");
  xhr.send();
