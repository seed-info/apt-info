...
title: 리베라스위트빌Ⅱ
categories: [아파트정보]
permalink: /apt/대전광역시서구리베라스위트빌Ⅱ
---

<a style="color: blue;" href="/apt/대전광역시서구">< 대전광역시서구  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 리베라스위트빌Ⅱ">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시서구리베라스위트빌Ⅱ");
  xhr.send();
