...
<a href="/apt/충청북도충주시호암동">[충청북도충주시 호암동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=호암동 한양">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도충주시호암동한양");
  xhr.send();
