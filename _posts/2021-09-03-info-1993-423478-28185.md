...
<a href="/apt/인천광역시연수구연수동">[인천광역시연수구 연수동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=연수동 효정">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시연수구연수동효정");
  xhr.send();
