...
<a style="color: green;" href="https://search.naver.com/search.naver?query=간석동 코지빌에이(HK)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시남동구간석동코지빌에이(HK)");
  xhr.send();
