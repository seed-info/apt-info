...
<a style="color: blue;" href="/apt/전라북도부안군줄포면줄포리">< 전라북도부안군 줄포면줄포리 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=줄포면줄포리 노을애">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도부안군줄포면줄포리노을애");
  xhr.send();
