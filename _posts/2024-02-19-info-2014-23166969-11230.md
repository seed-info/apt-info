...
<a style="color: blue;" href="/apt/서울특별시동대문구답십리동">< 서울특별시동대문구 답십리동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=답십리동 래미안위브">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구답십리동래미안위브");
  xhr.send();
