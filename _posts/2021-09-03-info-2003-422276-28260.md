...
<a href="/apt/인천광역시서구검암동">[인천광역시서구 검암동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=검암동 서해그랑블">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시서구검암동서해그랑블");
  xhr.send();
