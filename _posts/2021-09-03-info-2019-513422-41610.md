...
<a href="/apt/경기도광주시태전동">[경기도광주시 태전동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=태전동 태전7지구C-13BL태전파크자이">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도광주시태전동태전7지구C-13BL태전파크자이");
  xhr.send();
