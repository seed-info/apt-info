...
<a style="color: green;" href="https://search.naver.com/search.naver?query=조례동 골드클래스시그니처">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도순천시조례동골드클래스시그니처");
  xhr.send();
