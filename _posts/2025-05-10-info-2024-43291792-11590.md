...
<a style="color: green;" href="https://search.naver.com/search.naver?query=상도동 상도푸르지오클라베뉴">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구상도동상도푸르지오클라베뉴");
  xhr.send();
