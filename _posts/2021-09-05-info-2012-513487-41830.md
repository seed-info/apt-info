...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=양서면양수리 랑데뷰(B동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도양평군양서면양수리랑데뷰(B동)");
  xhr.send();
