...
<a style="color: green;" href="https://search.naver.com/search.naver?query=이매동 이매촌(동부코오롱)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도성남시분당구이매동이매촌(동부코오롱)");
  xhr.send();
