...
title: 목화(삼산주택)
categories: [아파트정보]
permalink: /apt/경상북도영천시목화(삼산주택)
---

<a style="color: blue;" href="/apt/경상북도영천시">< 경상북도영천시  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 목화(삼산주택)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도영천시목화(삼산주택)");
  xhr.send();
