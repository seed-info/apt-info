...
<a style="color: green;" href="https://search.naver.com/search.naver?query=내덕동 장유역중흥S-클래스더퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도김해시내덕동장유역중흥S-클래스더퍼스트");
  xhr.send();
