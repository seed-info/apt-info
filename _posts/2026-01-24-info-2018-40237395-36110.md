...
<a style="color: green;" href="https://search.naver.com/search.naver?query=다정동 가온마을1단지(힐스테이트)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시다정동가온마을1단지(힐스테이트)");
  xhr.send();
