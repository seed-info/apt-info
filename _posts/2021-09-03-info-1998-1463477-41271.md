...
<a href="/apt/경기도안산시상록구건건동">[경기도안산시상록구 건건동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=건건동 반월서해">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안산시상록구건건동반월서해");
  xhr.send();
