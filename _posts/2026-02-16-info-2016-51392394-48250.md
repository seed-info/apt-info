...
title: 더테라스(5)
categories: [아파트정보]
permalink: /apt/경상남도김해시삼정동더테라스(5)
---

<a style="color: blue;" href="/apt/경상남도김해시삼정동">< 경상남도김해시 삼정동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=삼정동 더테라스(5)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도김해시삼정동더테라스(5)");
  xhr.send();
