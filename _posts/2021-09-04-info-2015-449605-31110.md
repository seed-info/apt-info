...
<br><a href="https://search.naver.com/search.naver?query=복산동 번영로효성해링턴플레이스2차아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시중구복산동번영로효성해링턴플레이스2차아파트");
  xhr.send();
