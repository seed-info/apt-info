...
<a style="color: blue;" href="/apt/서울특별시구로구궁동">[서울특별시구로구 궁동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=궁동 다청림(106동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시구로구궁동다청림(106동)");
  xhr.send();
