...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=삼양이동 삼양대일(가동나동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시삼양이동삼양대일(가동나동)");
  xhr.send();
