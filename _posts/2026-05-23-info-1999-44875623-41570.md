...
<a style="color: blue;" href="/apt/경기도김포시북변동">< 경기도김포시 북변동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=북변동 풍년마을(서광)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도김포시북변동풍년마을(서광)");
  xhr.send();
