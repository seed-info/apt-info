...
<a href="/apt/서울특별시강동구명일동">[서울특별시강동구 명일동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=명일동 다성이즈빌(명일4차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강동구명일동다성이즈빌(명일4차)");
  xhr.send();
