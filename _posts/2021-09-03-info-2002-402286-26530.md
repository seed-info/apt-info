...
<a href="/apt/부산광역시사상구주례동">[부산광역시사상구 주례동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=주례동 주례청구">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시사상구주례동주례청구");
  xhr.send();
