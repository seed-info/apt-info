...
layout: post
comments: true
title: 엘지메트로시티(230~238)
categories: [아파트정보]
permalink: /apt/부산광역시남구용호동엘지메트로시티(230~238)
---

<a href="/apt/부산광역시남구용호동">[부산광역시남구 용호동지역 실거래 리스트]</a>

엘지메트로시티(230~238) 실거래 상세정보
...
<script type="text/javascript">
  ...
  xhr.open('GET', 'https://sub.seed-info.com/apt/부산광역시남구용호동엘지메트로시티(230~238)');
  xhr.send();
