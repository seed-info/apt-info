...
<a style="color: green;" href="https://search.naver.com/search.naver?query=송내동 LH지행역더퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시송내동LH지행역더퍼스트");
  xhr.send();
