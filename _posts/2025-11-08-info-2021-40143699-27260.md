...
<a style="color: green;" href="https://search.naver.com/search.naver?query=중동 수성골드클래스더센텀">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구중동수성골드클래스더센텀");
  xhr.send();
