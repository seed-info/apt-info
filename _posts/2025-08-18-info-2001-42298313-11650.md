...
<a style="color: green;" href="https://search.naver.com/search.naver?query=양재동 새티스(402-10)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구양재동새티스(402-10)");
  xhr.send();
