...
<br><a href="https://search.naver.com/search.naver?query=태전동 힐스테이트태전(C-4,1501~1506동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도광주시태전동힐스테이트태전(C-4,1501~1506동)");
  xhr.send();
