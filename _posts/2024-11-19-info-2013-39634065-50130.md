...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서홍동 서강파인힐2차">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시서홍동서강파인힐2차");
  xhr.send();
