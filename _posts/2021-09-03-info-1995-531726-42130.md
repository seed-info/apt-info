...
<a href="/apt/강원도원주시호저면만종리">[강원도원주시 호저면만종리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=호저면만종리 대보">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/강원도원주시호저면만종리대보");
  xhr.send();
