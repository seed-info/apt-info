...
title: 방배현대빌라트(999-2)
categories: [아파트정보]
permalink: /apt/서울특별시서초구방배동방배현대빌라트(999-2)
---

<a style="color: blue;" href="/apt/서울특별시서초구방배동">< 서울특별시서초구 방배동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=방배동 방배현대빌라트(999-2)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구방배동방배현대빌라트(999-2)");
  xhr.send();
