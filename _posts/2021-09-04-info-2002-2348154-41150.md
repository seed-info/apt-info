...
title: 가능신진
categories: [아파트정보]
permalink: /apt/경기도의정부시가능동가능신진
---

<a href="/apt/경기도의정부시가능동">[경기도의정부시 가능동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=가능동 가능신진">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도의정부시가능동가능신진");
  xhr.send();
