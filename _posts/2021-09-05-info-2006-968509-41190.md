...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=중동 위브더스테이트(201,202,203동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도부천시중동위브더스테이트(201,202,203동)");
  xhr.send();
