...
<a style="color: green;" href="https://search.naver.com/search.naver?query=완도읍가용리 쌍용더플래티넘완도">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도완도군완도읍가용리쌍용더플래티넘완도");
  xhr.send();
