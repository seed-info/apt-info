...
<a style="color: green;" href="https://search.naver.com/search.naver?query=심곡본동 태경삼익(에이동,비동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도부천시심곡본동태경삼익(에이동,비동)");
  xhr.send();
