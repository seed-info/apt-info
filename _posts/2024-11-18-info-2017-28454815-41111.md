...
<a style="color: green;" href="https://search.naver.com/search.naver?query=율전동 성균관대역동문디이스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도수원시장안구율전동성균관대역동문디이스트");
  xhr.send();
