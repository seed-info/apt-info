...
<a style="color: blue;" href="/apt/전라남도여수시수정동">< 전라남도여수시 수정동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=수정동 여수블루써밋">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시수정동여수블루써밋");
  xhr.send();
