...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=대성동 은어송마을2단지(코오롱하늘채)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시동구대성동은어송마을2단지(코오롱하늘채)");
  xhr.send();
