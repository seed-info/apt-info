...
<a href="/apt/경기도평택시소사동">[경기도평택시 소사동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=소사동 평택효성해링턴플레이스1단지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시소사동평택효성해링턴플레이스1단지");
  xhr.send();
