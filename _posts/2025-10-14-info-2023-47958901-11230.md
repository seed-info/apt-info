...
<a style="color: green;" href="https://search.naver.com/search.naver?query=용두동 청량리역해링턴플레이스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구용두동청량리역해링턴플레이스");
  xhr.send();
