...
<a href="/apt/전라북도남원시하정동">[전라북도남원시 하정동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=하정동 발트하임">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도남원시하정동발트하임");
  xhr.send();
