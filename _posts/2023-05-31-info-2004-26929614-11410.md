...
title: 장미
categories: [아파트정보]
permalink: /apt/서울특별시서대문구충정로3가장미
---

<a style="color: blue;" href="/apt/서울특별시서대문구충정로3가">< 서울특별시서대문구 충정로3가 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=충정로3가 장미">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구충정로3가장미");
  xhr.send();
