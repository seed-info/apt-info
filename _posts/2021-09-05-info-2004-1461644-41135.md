...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=정자동 동양정자파라곤(2단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도성남시분당구정자동동양정자파라곤(2단지)");
  xhr.send();
