...
<a href="/apt/경기도동두천시동두천동">[경기도동두천시 동두천동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=동두천동 신창비바패밀리(2단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시동두천동신창비바패밀리(2단지)");
  xhr.send();
