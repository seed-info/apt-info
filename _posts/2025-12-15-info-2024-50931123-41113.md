...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서둔동 힐스테이트수원파크포레">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도수원시권선구서둔동힐스테이트수원파크포레");
  xhr.send();
