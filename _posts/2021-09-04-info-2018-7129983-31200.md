...
<br><a href="https://search.naver.com/search.naver?query=명촌동 울산강변효성해링턴플레이스(82블럭)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구명촌동울산강변효성해링턴플레이스(82블럭)");
  xhr.send();
