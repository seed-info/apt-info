...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=범천동 가야누리애더센트리즈">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구범천동가야누리애더센트리즈");
  xhr.send();
