...
<a href="/apt/충청남도논산시연산면연산리">[충청남도논산시 연산면연산리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=연산면연산리 렉스톤">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도논산시연산면연산리렉스톤");
  xhr.send();
