...
<a style="color: blue;" href="/apt/서울특별시용산구서계동">< 서울특별시용산구 서계동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=서계동 어반허브서울스테이션(UrbanHubSeoulStation)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구서계동어반허브서울스테이션(UrbanHubSeoulStation)");
  xhr.send();
