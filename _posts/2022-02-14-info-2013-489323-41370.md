...
<a style="color: blue;" href="/apt/경기도오산시세교동">< 경기도오산시 세교동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=세교동 잔다리마을1단지(True)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도오산시세교동잔다리마을1단지(True)");
  xhr.send();
