...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=북변동 동변마을(동양파라곤2차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도김포시북변동동변마을(동양파라곤2차)");
  xhr.send();
