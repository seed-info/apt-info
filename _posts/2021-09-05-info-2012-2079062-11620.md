...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=봉천동 서울대역마에스트로">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시관악구봉천동서울대역마에스트로");
  xhr.send();
