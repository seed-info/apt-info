...
<a href="/apt/서울특별시성북구종암동">[서울특별시성북구 종암동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=종암동 삼성래미안">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구종암동삼성래미안");
  xhr.send();
