...
<a style="color: blue;" href="/apt/경기도동두천시생연동">< 경기도동두천시 생연동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=생연동 태양아파트(1동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시생연동태양아파트(1동)");
  xhr.send();
