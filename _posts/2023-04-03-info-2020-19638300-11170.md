...
<a style="color: green;" href="https://search.naver.com/search.naver?query=한강로3가 용산센트럴파크해링턴스퀘어">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구한강로3가용산센트럴파크해링턴스퀘어");
  xhr.send();
