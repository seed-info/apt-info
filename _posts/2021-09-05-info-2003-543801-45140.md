...
<a style="color: blue;" href="/apt/전라북도익산시함열읍와리">[전라북도익산시 함열읍와리 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=함열읍와리 함열제일">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도익산시함열읍와리함열제일");
  xhr.send();
