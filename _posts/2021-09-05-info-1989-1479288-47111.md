...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=동해면도구리 이화해변타운">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도포항시남구동해면도구리이화해변타운");
  xhr.send();
