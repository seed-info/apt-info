...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=월야면월야리 休(휴)Palasce">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도함평군월야면월야리休(휴)Palasce");
  xhr.send();
