...
<a style="color: green;" href="https://search.naver.com/search.naver?query=이태원동 ThePlusⅢ">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구이태원동ThePlusⅢ");
  xhr.send();
