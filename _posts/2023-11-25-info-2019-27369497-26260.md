...
<a style="color: blue;" href="/apt/부산광역시동래구복천동">< 부산광역시동래구 복천동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=복천동 동래더씨드">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동래구복천동동래더씨드");
  xhr.send();
