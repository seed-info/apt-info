...
<a style="color: green;" href="https://search.naver.com/search.naver?query=모현동1가 모현오투그란데프리미어">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도익산시모현동1가모현오투그란데프리미어");
  xhr.send();
