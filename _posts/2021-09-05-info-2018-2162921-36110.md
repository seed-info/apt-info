...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=다정동 가온마을5단지(중흥에스클래스센텀시티)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시다정동가온마을5단지(중흥에스클래스센텀시티)");
  xhr.send();
