...
<a href="/apt/충청남도예산군응봉면송석리">[충청남도예산군 응봉면송석리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=응봉면송석리 장백">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도예산군응봉면송석리장백");
  xhr.send();
