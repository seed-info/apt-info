...
<a href="/apt/서울특별시용산구한강로2가">[서울특별시용산구 한강로2가 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=한강로2가 용산파크e-편한세상">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구한강로2가용산파크e-편한세상");
  xhr.send();
