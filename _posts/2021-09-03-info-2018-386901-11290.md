...
<a href="/apt/서울특별시성북구동소문동5가">[서울특별시성북구 동소문동5가 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=동소문동5가 성신여대역솔하임">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구동소문동5가성신여대역솔하임");
  xhr.send();
