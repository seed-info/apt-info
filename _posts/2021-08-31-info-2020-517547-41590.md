---
    layout: post
    comments: true
    title: 동탄2신도시 4차 동원로얄듀크포레
    categories: [아파트정보]
    permalink: /apt/경기도화성시영천동동탄2신도시 4차 동원로얄듀크포레
    ---

    동탄2신도시 4차 동원로얄듀크포레 실거래 상세정보
    ...
    <script type="text/javascript">
      ...
      xhr.open('GET', 'https://sub.seed-info.com/apt/경기도화성시영천동동탄2신도시 4차 동원로얄듀크포레');
      xhr.send();
