...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서울중구 신당동파라다이스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시중구서울중구신당동파라다이스");
  xhr.send();
