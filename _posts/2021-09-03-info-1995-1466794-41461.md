...
<a href="/apt/경기도용인시처인구모현읍초부리">[경기도용인시처인구 모현읍초부리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=모현읍초부리 태영(A동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도용인시처인구모현읍초부리태영(A동)");
  xhr.send();
