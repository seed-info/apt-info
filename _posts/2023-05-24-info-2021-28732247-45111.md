...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서완산동2가 전주서완산골드클래스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도전주시완산구서완산동2가전주서완산골드클래스");
  xhr.send();
