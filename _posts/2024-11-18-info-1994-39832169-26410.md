...
title: 구서우성
categories: [아파트정보]
permalink: /apt/부산광역시금정구구서우성
---

<a style="color: blue;" href="/apt/부산광역시금정구">< 부산광역시금정구  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 구서우성">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구구서우성");
  xhr.send();
