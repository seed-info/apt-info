...
2021년 09월 04일 <a href="/apt/전라남도여수시">전라남도여수시</a> 화정면하화리 실거래 정보
...
<table>
  <tr>
    <td colspan="4" style="font-weight: bold;"><a href="/apt/전라남도여수시화정면하화리{name_without_space}">오늘 등록된 실거래 정보가 없습니다</a> &nbsp;&nbsp;&nbsp; <a style="color: blue; font-size: smaller;" href="/apt/전라남도여수시화정면하화리{name_without_space}">[실거래상세정보]</a></td>
  </tr>
