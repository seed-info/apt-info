...
title: 썬라이즈A동
categories: [아파트정보]
permalink: /apt/부산광역시동구초량동썬라이즈A동
---

<a href="/apt/부산광역시동구초량동">[부산광역시동구 초량동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=초량동 썬라이즈A동">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동구초량동썬라이즈A동");
  xhr.send();
