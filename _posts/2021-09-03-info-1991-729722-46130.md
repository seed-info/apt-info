...
<a href="/apt/전라남도여수시신기동">[전라남도여수시 신기동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=신기동 신화">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시신기동신화");
  xhr.send();
