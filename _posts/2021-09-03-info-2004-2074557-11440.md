...
title: 기정MAY(247-28)
categories: [아파트정보]
permalink: /apt/서울특별시마포구서교동기정MAY(247-28)
---

<a href="/apt/서울특별시마포구서교동">[서울특별시마포구 서교동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=서교동 기정MAY(247-28)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시마포구서교동기정MAY(247-28)");
  xhr.send();
