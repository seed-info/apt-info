...
<a href="/apt/서울특별시성북구석관동">[서울특별시성북구 석관동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=석관동 코오롱">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구석관동코오롱");
  xhr.send();
