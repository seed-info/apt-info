...
title: 초량베스티움센트럴베이
categories: [아파트정보]
permalink: /apt/부산광역시동구초량베스티움센트럴베이
---

<a style="color: blue;" href="/apt/부산광역시동구">< 부산광역시동구  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 초량베스티움센트럴베이">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동구초량베스티움센트럴베이");
  xhr.send();
