...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=공릉동 화랑해링턴플레이스아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시노원구공릉동화랑해링턴플레이스아파트");
  xhr.send();
