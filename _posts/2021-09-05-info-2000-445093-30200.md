...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=지족동 열매마을7단지(현대1차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시유성구지족동열매마을7단지(현대1차)");
  xhr.send();
