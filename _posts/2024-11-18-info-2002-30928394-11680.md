...
title: 메트로
categories: [아파트정보]
permalink: /apt/서울특별시강남구대치동메트로
---

<a style="color: blue;" href="/apt/서울특별시강남구대치동">< 서울특별시강남구 대치동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=대치동 메트로">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강남구대치동메트로");
  xhr.send();
