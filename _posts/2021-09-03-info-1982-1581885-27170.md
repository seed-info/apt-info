...
<a href="/apt/대구광역시서구중리동">[대구광역시서구 중리동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=중리동 일신(720-1)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시서구중리동일신(720-1)");
  xhr.send();
