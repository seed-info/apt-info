...
<a href="/apt/대전광역시유성구하기동">[대전광역시유성구 하기동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=하기동 송림마을6단지(금실풍요로운)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시유성구하기동송림마을6단지(금실풍요로운)");
  xhr.send();
