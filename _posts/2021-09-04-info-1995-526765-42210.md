...
<a href="/apt/강원도속초시교동">[강원도속초시 교동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=교동 로얄나하나(904-5)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/강원도속초시교동로얄나하나(904-5)");
  xhr.send();
