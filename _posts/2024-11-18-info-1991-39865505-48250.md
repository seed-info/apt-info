...
title: 대근(다라)
categories: [아파트정보]
permalink: /apt/경상남도김해시대근(다라)
---

<a style="color: blue;" href="/apt/경상남도김해시">< 경상남도김해시  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 대근(다라)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도김해시대근(다라)");
  xhr.send();
