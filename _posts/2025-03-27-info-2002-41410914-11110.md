...
<a style="color: green;" href="https://search.naver.com/search.naver?query=창신동 MID그린(8동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구창신동MID그린(8동)");
  xhr.send();
