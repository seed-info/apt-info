...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=오라이동 벽강하이본타워(5차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시오라이동벽강하이본타워(5차)");
  xhr.send();
