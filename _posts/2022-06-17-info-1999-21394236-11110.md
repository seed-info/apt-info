...
title: (60-1)
categories: [아파트정보]
permalink: /apt/서울특별시종로구연건동(60-1)
---

<a style="color: blue;" href="/apt/서울특별시종로구연건동">< 서울특별시종로구 연건동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=연건동 (60-1)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구연건동(60-1)");
  xhr.send();
