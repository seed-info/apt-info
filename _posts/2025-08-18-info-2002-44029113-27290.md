...
<a style="color: green;" href="https://search.naver.com/search.naver?query=상인동 상인메트로빌104동">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시달서구상인동상인메트로빌104동");
  xhr.send();
