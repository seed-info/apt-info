...
<a style="color: green;" href="https://search.naver.com/search.naver?query=망월동 미사강변효성해링턴플레이스엔에이치에프">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도하남시망월동미사강변효성해링턴플레이스엔에이치에프");
  xhr.send();
