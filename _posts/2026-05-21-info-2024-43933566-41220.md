...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서정동 힐스테이트평택더퍼스트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시서정동힐스테이트평택더퍼스트");
  xhr.send();
