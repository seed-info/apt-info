...
<a style="color: green;" href="https://search.naver.com/search.naver?query=고산동 오포자이디오브(4단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도광주시고산동오포자이디오브(4단지)");
  xhr.send();
