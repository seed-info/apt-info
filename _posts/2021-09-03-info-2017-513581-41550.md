...
<a href="/apt/경기도안성시가사동">[경기도안성시 가사동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=가사동 안성푸르지오">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안성시가사동안성푸르지오");
  xhr.send();
