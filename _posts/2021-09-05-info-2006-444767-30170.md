...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=용문동 용문동리베라아이누리아파트(1단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대전광역시서구용문동용문동리베라아이누리아파트(1단지)");
  xhr.send();
