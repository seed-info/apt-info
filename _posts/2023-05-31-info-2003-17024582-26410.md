...
<a style="color: green;" href="https://search.naver.com/search.naver?query=구서동 세진에버그린B동">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구구서동세진에버그린B동");
  xhr.send();
