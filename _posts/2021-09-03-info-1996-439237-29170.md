...
<a href="/apt/광주광역시북구연제동">[광주광역시북구 연제동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=연제동 새한A">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시북구연제동새한A");
  xhr.send();
