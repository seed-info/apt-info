...
title: MID그린(4동)
categories: [아파트정보]
permalink: /apt/서울특별시종로구창신동MID그린(4동)
---

<a style="color: blue;" href="/apt/서울특별시종로구창신동">< 서울특별시종로구 창신동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=창신동 MID그린(4동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시종로구창신동MID그린(4동)");
  xhr.send();
