...
title: 삼정코아
categories: [아파트정보]
permalink: /apt/서울특별시강서구방화동삼정코아
---

<a href="/apt/서울특별시강서구방화동">[서울특별시강서구 방화동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=방화동 삼정코아">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강서구방화동삼정코아");
  xhr.send();
