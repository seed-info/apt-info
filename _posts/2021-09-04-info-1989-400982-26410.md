...
<a href="/apt/부산광역시금정구구서동">[부산광역시금정구 구서동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=구서동 선경3">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구구서동선경3");
  xhr.send();
