...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=포승읍만호리 더스위트하버">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도평택시포승읍만호리더스위트하버");
  xhr.send();
