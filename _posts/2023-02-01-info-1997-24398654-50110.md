...
<a style="color: green;" href="https://search.naver.com/search.naver?query=도련일동 도련한양(도련별장맨션)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도제주시도련일동도련한양(도련별장맨션)");
  xhr.send();
