...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=용두동 동대문푸르지오시티(도시형생활주택)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구용두동동대문푸르지오시티(도시형생활주택)");
  xhr.send();
