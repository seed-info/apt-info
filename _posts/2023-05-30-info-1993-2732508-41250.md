...
<a style="color: green;" href="https://search.naver.com/search.naver?query=생연동 에이스아파트(2차)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시생연동에이스아파트(2차)");
  xhr.send();
