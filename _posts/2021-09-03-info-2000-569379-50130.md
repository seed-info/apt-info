...
<a href="/apt/제주특별자치도서귀포시토평동">[제주특별자치도서귀포시 토평동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=토평동 토평반석타운(가동,나동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/제주특별자치도서귀포시토평동토평반석타운(가동,나동)");
  xhr.send();
