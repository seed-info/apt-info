...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=답십리동 래미안엘파인아파트">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구답십리동래미안엘파인아파트");
  xhr.send();
