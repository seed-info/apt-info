...
<a href="/apt/서울특별시용산구신계동">[서울특별시용산구 신계동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=신계동 용산e편한세상">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구신계동용산e편한세상");
  xhr.send();
