...
title: 한신플러스A
categories: [아파트정보]
permalink: /apt/서울특별시성북구동소문동4가한신플러스A
---

<a style="color: blue;" href="/apt/서울특별시성북구동소문동4가">< 서울특별시성북구 동소문동4가 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=동소문동4가 한신플러스A">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구동소문동4가한신플러스A");
  xhr.send();
