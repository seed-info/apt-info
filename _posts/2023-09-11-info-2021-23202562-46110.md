...
<a style="color: green;" href="https://search.naver.com/search.naver?query=연산동 목포백련골드클래스9차">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도목포시연산동목포백련골드클래스9차");
  xhr.send();
