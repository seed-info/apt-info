...
<a href="/apt/울산광역시북구정자동">[울산광역시북구 정자동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=정자동 벽산블루밍">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구정자동벽산블루밍");
  xhr.send();
