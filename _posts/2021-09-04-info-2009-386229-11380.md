...
title: 수색자이1단지
categories: [아파트정보]
permalink: /apt/서울특별시은평구수색동수색자이1단지
---

<a href="/apt/서울특별시은평구수색동">[서울특별시은평구 수색동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=수색동 수색자이1단지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시은평구수색동수색자이1단지");
  xhr.send();
