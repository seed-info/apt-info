...
<a href="/apt/전라북도익산시동산동">[전라북도익산시 동산동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=동산동 제일(고층)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라북도익산시동산동제일(고층)");
  xhr.send();
