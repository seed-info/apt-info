...
<a style="color: green;" href="https://search.naver.com/search.naver?query=산울동 산울마을2단지(세종자이더시티)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시산울동산울마을2단지(세종자이더시티)");
  xhr.send();
