...
<a href="/apt/부산광역시사상구덕포동">[부산광역시사상구 덕포동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=덕포동 유원">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시사상구덕포동유원");
  xhr.send();
