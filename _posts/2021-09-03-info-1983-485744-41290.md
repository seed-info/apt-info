...
<a href="/apt/경기도과천시별양동">[경기도과천시 별양동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=별양동 주공4">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도과천시별양동주공4");
  xhr.send();
