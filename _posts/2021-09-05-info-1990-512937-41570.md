...
title: 한일
categories: [아파트정보]
permalink: /apt/경기도김포시북변동한일
---

<a href="/apt/경기도김포시북변동">[경기도김포시 북변동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=북변동 한일">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도김포시북변동한일");
  xhr.send();
