...
<table>
  <tr>
    <td colspan="4" style="font-weight: bold;"><a href="https://search.naver.com/search.naver?query=소태동 무등산골드클래스">무등산골드클래스</a> &nbsp;&nbsp;&nbsp; <a style="color: blue; href="/apt/광주광역시동구소태동무등산골드클래스">[실거래상세분석]</a></td>
  </tr>
