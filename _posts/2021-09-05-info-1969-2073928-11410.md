...
title: 홍일
categories: [아파트정보]
permalink: /apt/서울특별시서대문구홍제동홍일
---

<a style="color: blue;" href="/apt/서울특별시서대문구홍제동">[서울특별시서대문구 홍제동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=홍제동 홍일">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구홍제동홍일");
  xhr.send();
