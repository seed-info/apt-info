...
categories: [아파트정보]
permalink: /apt/울산광역시북구울산북구오토밸리로효성해링턴플레이스아파트
---

<a style="color: blue;" href="/apt/울산광역시북구울산북구">< 울산광역시북구 울산북구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=울산북구 오토밸리로효성해링턴플레이스아파트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구울산북구오토밸리로효성해링턴플레이스아파트");
  xhr.send();
