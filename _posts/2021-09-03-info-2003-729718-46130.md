...
<a href="/apt/전라남도여수시문수동">[전라남도여수시 문수동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=문수동 백상3차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시문수동백상3차");
  xhr.send();
