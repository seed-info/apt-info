...
title: 충무
categories: [아파트정보]
permalink: /apt/서울특별시중구묵정동충무
---

<a href="/apt/서울특별시중구묵정동">[서울특별시중구 묵정동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=묵정동 충무">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시중구묵정동충무");
  xhr.send();
