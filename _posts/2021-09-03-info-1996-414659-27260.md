...
<a href="/apt/대구광역시수성구시지동">[대구광역시수성구 시지동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=시지동 노변청구">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구시지동노변청구");
  xhr.send();
