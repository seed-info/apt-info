...
<a style="color: blue;" href="/apt/부산광역시기장군정관읍모전리">< 부산광역시기장군 정관읍모전리 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=정관읍모전리 이지더원3차">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시기장군정관읍모전리이지더원3차");
  xhr.send();
