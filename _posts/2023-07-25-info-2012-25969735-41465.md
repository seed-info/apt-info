...
<a style="color: green;" href="https://search.naver.com/search.naver?query=상현동 광교자이더클래스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도용인시수지구상현동광교자이더클래스");
  xhr.send();
