...
<a href="/apt/대구광역시수성구노변동">[대구광역시수성구 노변동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=노변동 노변월드시티">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시수성구노변동노변월드시티");
  xhr.send();
