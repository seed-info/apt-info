...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=금호동4가 리버마이다스빌">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구금호동4가리버마이다스빌");
  xhr.send();
