...
<a href="/apt/경기도구리시토평동">[경기도구리시 토평동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=토평동 상록">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도구리시토평동상록");
  xhr.send();
