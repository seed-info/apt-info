...
<a href="/apt/경상남도통영시태평동">[경상남도통영시 태평동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=태평동 주영라이프">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상남도통영시태평동주영라이프");
  xhr.send();
