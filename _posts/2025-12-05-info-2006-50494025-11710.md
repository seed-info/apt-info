...
<a style="color: green;" href="https://search.naver.com/search.naver?query=문정동 자이파인빌(102동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구문정동자이파인빌(102동)");
  xhr.send();
