...
<a style="color: green;" href="https://search.naver.com/search.naver?query=서울서초구,서울용산구 남산대림">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구서울서초구,서울용산구남산대림");
  xhr.send();
