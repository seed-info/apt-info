...
title: 다성이즈빌(324-6)
categories: [아파트정보]
permalink: /apt/서울특별시강동구길동다성이즈빌(324-6)
---

<a href="/apt/서울특별시강동구길동">[서울특별시강동구 길동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=길동 다성이즈빌(324-6)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시강동구길동다성이즈빌(324-6)");
  xhr.send();
