...
title: 대건딜라이트
categories: [아파트정보]
permalink: /apt/서울특별시서초구방배동대건딜라이트
---

<a style="color: blue;" href="/apt/서울특별시서초구방배동">< 서울특별시서초구 방배동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=방배동 대건딜라이트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구방배동대건딜라이트");
  xhr.send();
