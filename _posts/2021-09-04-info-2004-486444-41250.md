...
<a href="/apt/경기도동두천시지행동">[경기도동두천시 지행동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=지행동 대방노블랜드(8단지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도동두천시지행동대방노블랜드(8단지)");
  xhr.send();
