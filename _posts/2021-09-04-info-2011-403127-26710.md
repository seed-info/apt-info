...
<a href="/apt/부산광역시기장군정관읍모전리">[부산광역시기장군 정관읍모전리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=정관읍모전리 이지더원">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시기장군정관읍모전리이지더원");
  xhr.send();
