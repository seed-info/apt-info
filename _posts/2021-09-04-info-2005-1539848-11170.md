...
<a href="/apt/서울특별시용산구문배동">[서울특별시용산구 문배동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=문배동 이안용산1차(103동)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구문배동이안용산1차(103동)");
  xhr.send();
