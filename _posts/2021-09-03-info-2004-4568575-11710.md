...
title: 프라임
categories: [아파트정보]
permalink: /apt/서울특별시송파구문정동프라임
---

<a href="/apt/서울특별시송파구문정동">[서울특별시송파구 문정동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=문정동 프라임">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구문정동프라임");
  xhr.send();
