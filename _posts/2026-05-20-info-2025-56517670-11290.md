...
<a style="color: green;" href="https://search.naver.com/search.naver?query=장위동 장위자이레디언트(4단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성북구장위동장위자이레디언트(4단지)");
  xhr.send();
