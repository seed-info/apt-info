...
<a style="color: green;" href="https://search.naver.com/search.naver?query=불로동 신검단중앙역우미린클래스원">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시서구불로동신검단중앙역우미린클래스원");
  xhr.send();
