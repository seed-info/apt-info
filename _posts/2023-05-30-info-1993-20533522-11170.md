...
<a style="color: green;" href="https://search.naver.com/search.naver?query=한강로3가 전자타운한신(A)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시용산구한강로3가전자타운한신(A)");
  xhr.send();
