...
<a style="color: blue;" href="/apt/서울특별시서초구우면동">[서울특별시서초구 우면동 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=우면동 서초네이처힐6단지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구우면동서초네이처힐6단지");
  xhr.send();
