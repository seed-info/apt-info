...
<a href="/apt/전라남도여수시율촌면조화리">[전라남도여수시 율촌면조화리 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=율촌면조화리 조화(A,B,C)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도여수시율촌면조화리조화(A,B,C)");
  xhr.send();
