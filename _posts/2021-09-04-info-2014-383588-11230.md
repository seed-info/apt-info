...
<a href="/apt/서울특별시동대문구용두동">[서울특별시동대문구 용두동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=용두동 한양아이클래스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구용두동한양아이클래스");
  xhr.send();
