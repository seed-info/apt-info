...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=우정동 우정코아루웰메이드">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시중구우정동우정코아루웰메이드");
  xhr.send();
