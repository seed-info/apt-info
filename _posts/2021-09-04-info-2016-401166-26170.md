...
title: 범일역이즈팰리스
categories: [아파트정보]
permalink: /apt/부산광역시동구범일동범일역이즈팰리스
---

<a href="/apt/부산광역시동구범일동">[부산광역시동구 범일동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=범일동 범일역이즈팰리스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시동구범일동범일역이즈팰리스");
  xhr.send();
