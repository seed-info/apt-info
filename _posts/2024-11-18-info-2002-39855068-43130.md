...
title: 호암리버빌(1단지)
categories: [아파트정보]
permalink: /apt/충청북도충주시호암리버빌(1단지)
---

<a style="color: blue;" href="/apt/충청북도충주시">< 충청북도충주시  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 호암리버빌(1단지)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청북도충주시호암리버빌(1단지)");
  xhr.send();
