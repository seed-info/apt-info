...
<a href="/apt/경상북도구미시임수동">[경상북도구미시 임수동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=임수동 강변캐슬">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경상북도구미시임수동강변캐슬");
  xhr.send();
