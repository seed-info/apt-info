...
<a style="color: green;" href="https://search.naver.com/search.naver?query=교문동 하나(유원)아파트">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도구리시교문동하나(유원)아파트");
  xhr.send();
