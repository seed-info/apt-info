...
<a style="color: blue;" href="/apt/광주광역시동구금남로5가">[광주광역시동구 금남로5가 전체 실거래 정보]</a>

<a style="color: greed;" href="https://search.naver.com/search.naver?query=금남로5가 AM-City하이클래스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시동구금남로5가AM-City하이클래스");
  xhr.send();
