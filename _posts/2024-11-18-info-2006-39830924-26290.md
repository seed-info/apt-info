...
title: 일동지에닌
categories: [아파트정보]
permalink: /apt/부산광역시남구일동지에닌
---

<a style="color: blue;" href="/apt/부산광역시남구">< 부산광역시남구  전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query= 일동지에닌">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시남구일동지에닌");
  xhr.send();
