...
title: 세기1(다라동)
categories: [아파트정보]
permalink: /apt/제주특별자치도서귀포시동홍동세기1(다라동)
---

<a href="/apt/제주특별자치도서귀포시동홍동">제주특별자치도서귀포시 동홍동지역 실거래 리스트</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', 'https://sub.seed-info.com/apt/제주특별자치도서귀포시동홍동세기1(다라동)');
  xhr.send();
