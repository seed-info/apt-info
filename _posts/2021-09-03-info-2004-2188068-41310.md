...
title: 영진
categories: [아파트정보]
permalink: /apt/경기도구리시수택동영진
---

<a href="/apt/경기도구리시수택동">[경기도구리시 수택동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=수택동 영진">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도구리시수택동영진");
  xhr.send();
