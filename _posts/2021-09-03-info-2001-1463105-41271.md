...
<a href="/apt/경기도안산시상록구이동">[경기도안산시상록구 이동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=이동 푸르지오2차">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안산시상록구이동푸르지오2차");
  xhr.send();
