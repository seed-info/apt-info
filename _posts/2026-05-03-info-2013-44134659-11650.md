...
<a style="color: green;" href="https://search.naver.com/search.naver?query=우면동 호반써밋서초파크">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구우면동호반써밋서초파크");
  xhr.send();
