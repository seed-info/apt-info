...
<a href="/apt/충청남도서산시석림동">[충청남도서산시 석림동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=석림동 삼보(682-1)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/충청남도서산시석림동삼보(682-1)");
  xhr.send();
