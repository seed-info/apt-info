...
<a href="/apt/경기도안성시석정동">[경기도안성시 석정동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=석정동 ELYSIA">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도안성시석정동ELYSIA");
  xhr.send();
