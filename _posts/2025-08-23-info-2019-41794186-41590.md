...
<a style="color: green;" href="https://search.naver.com/search.naver?query=산척동 중흥에스클래스에듀하이">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도화성시산척동중흥에스클래스에듀하이");
  xhr.send();
