...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=가야동 가야케이티이편한세상">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구가야동가야케이티이편한세상");
  xhr.send();
