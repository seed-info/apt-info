...
<a href="/apt/서울특별시서대문구남가좌동">[서울특별시서대문구 남가좌동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=남가좌동 백련미라보">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구남가좌동백련미라보");
  xhr.send();
