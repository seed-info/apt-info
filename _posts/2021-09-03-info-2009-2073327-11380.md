...
<a href="/apt/서울특별시은평구수색동">[서울특별시은평구 수색동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=수색동 DMC자이1단지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시은평구수색동DMC자이1단지");
  xhr.send();
