...
<a href="/apt/울산광역시북구염포동">[울산광역시북구 염포동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=염포동 성은">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시북구염포동성은");
  xhr.send();
