...
<a href="/apt/경기도고양시덕양구화정동">[경기도고양시덕양구 화정동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=화정동 은빛(미도파)5">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도고양시덕양구화정동은빛(미도파)5");
  xhr.send();
