...
<a style="color: green;" href="https://search.naver.com/search.naver?query=신용동 힐스테이트신용더리버">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/광주광역시북구신용동힐스테이트신용더리버");
  xhr.send();
