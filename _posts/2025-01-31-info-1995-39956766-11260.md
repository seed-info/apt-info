...
<a style="color: green;" href="https://search.naver.com/search.naver?query=면목동 개인택시주택조합(미성아파트)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시중랑구면목동개인택시주택조합(미성아파트)");
  xhr.send();
