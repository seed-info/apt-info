...
<a href="/apt/강원도평창군대관령면용산리">[강원도평창군 대관령면용산리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=대관령면용산리 용평빌리지">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/강원도평창군대관령면용산리용평빌리지");
  xhr.send();
