...
<a style="color: blue;" href="/apt/부산광역시금정구구서동">< 부산광역시금정구 구서동 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=구서동 구서협성엠파이어">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시금정구구서동구서협성엠파이어");
  xhr.send();
