...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=대방동 디어파크(파크빌리지)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구대방동디어파크(파크빌리지)");
  xhr.send();
