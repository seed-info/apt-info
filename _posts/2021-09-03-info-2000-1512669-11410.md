...
<a href="/apt/서울특별시서대문구현저동">[서울특별시서대문구 현저동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=현저동 독립문파크빌">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서대문구현저동독립문파크빌");
  xhr.send();
