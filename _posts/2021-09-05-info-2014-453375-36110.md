...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=아름동 범지기마을7단지호반에코시티">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시아름동범지기마을7단지호반에코시티");
  xhr.send();
