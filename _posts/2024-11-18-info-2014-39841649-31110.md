...
title: 골드클래스
categories: [아파트정보]
permalink: /apt/울산광역시중구울산중구골드클래스
---

<a style="color: blue;" href="/apt/울산광역시중구울산중구">< 울산광역시중구 울산중구 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=울산중구 골드클래스">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/울산광역시중구울산중구골드클래스");
  xhr.send();
