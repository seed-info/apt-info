...
<a href="/apt/대구광역시동구용계동">[대구광역시동구 용계동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=용계동 강변동서마을">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/대구광역시동구용계동강변동서마을");
  xhr.send();
