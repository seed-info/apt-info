...
<a href="/apt/전라남도화순군화순읍벽라리">[전라남도화순군 화순읍벽라리 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=화순읍벽라리 서라3">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/전라남도화순군화순읍벽라리서라3");
  xhr.send();
