...
<a href="/apt/서울특별시서초구우면동">[서울특별시서초구 우면동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=우면동 동고">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시서초구우면동동고");
  xhr.send();
