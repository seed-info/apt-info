...
<a style="color: green;" href="https://search.naver.com/search.naver?query=누읍동 중흥S-클래스에듀하이">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도오산시누읍동중흥S-클래스에듀하이");
  xhr.send();
