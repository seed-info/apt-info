...
<a style="color: blue;" href="/apt/강원도정선군여량면여량리">< 강원도정선군 여량면여량리 전체 실거래 정보</a>

<a style="color: green;" href="https://search.naver.com/search.naver?query=여량면여량리 성도">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/강원도정선군여량면여량리성도");
  xhr.send();
