...
title: 메리온시티
categories: [아파트정보]
permalink: /apt/부산광역시부산진구양정동메리온시티
---

<a href="/apt/부산광역시부산진구양정동">[부산광역시부산진구 양정동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=양정동 메리온시티">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/부산광역시부산진구양정동메리온시티");
  xhr.send();
