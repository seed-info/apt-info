...
<a href="/apt/서울특별시동대문구답십리동">[서울특별시동대문구 답십리동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=답십리동 동답한신">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동대문구답십리동동답한신");
  xhr.send();
