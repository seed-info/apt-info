...
<br><a href="https://search.naver.com/search.naver?query=보람동 호려울마을10단지(중흥S클래스)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/세종특별자치시보람동호려울마을10단지(중흥S클래스)");
  xhr.send();
