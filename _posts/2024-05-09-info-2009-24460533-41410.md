...
<a style="color: green;" href="https://search.naver.com/search.naver?query=당정동 대원칸타빌(102동)">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/경기도군포시당정동대원칸타빌(102동)");
  xhr.send();
