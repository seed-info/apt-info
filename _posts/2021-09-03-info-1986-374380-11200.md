...
<a href="/apt/서울특별시성동구응봉동">[서울특별시성동구 응봉동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=응봉동 대림(1차)">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시성동구응봉동대림(1차)");
  xhr.send();
