...
<a href="/apt/서울특별시동작구상도동">[서울특별시동작구 상도동 실거래 리스트]</a><br>
<a href="https://search.naver.com/search.naver?query=상도동 상도효성해링턴플레이스">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시동작구상도동상도효성해링턴플레이스");
  xhr.send();
