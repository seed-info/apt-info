...
<a style="color: greed;" href="https://search.naver.com/search.naver?query=항동 우남퍼스트빌더센트럴">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시구로구항동우남퍼스트빌더센트럴");
  xhr.send();
