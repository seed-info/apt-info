...
<a style="color: green;" href="https://search.naver.com/search.naver?query=가정동 엘에이치웨스턴블루힐">네이버에서 검색 ></a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/인천광역시서구가정동엘에이치웨스턴블루힐");
  xhr.send();
