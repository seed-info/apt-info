...
title: 경일
categories: [아파트정보]
permalink: /apt/서울특별시송파구송파동경일
---

<a href="/apt/서울특별시송파구송파동">[서울특별시송파구 송파동 실거래 리스트]</a>

<br><a href="https://search.naver.com/search.naver?query=송파동 경일">[네이버에서 검색]</a>
...
<script type="text/javascript">
  ...
  xhr.open('GET', "https://sub.seed-info.com/apt/서울특별시송파구송파동경일");
  xhr.send();
